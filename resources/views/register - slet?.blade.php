        ...
        <div class="col-lg-12">
            <div class="main-container">
                <div class="box">
                    ...
                    <h1>Opret dig en bruger herunder</h1>
                    <form method="POST" action="{{ route('register') }}">
                            @csrf

                            <div class="form-group row">
                                <div class="col-12">
                                    <input placeholder="Navn" id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-3">
                                    ...
                                    <a href="{{ route('login') }}">Har du allerede en bruger?</a>
                                </div>
                            </div>
                        </form>
                </div>
