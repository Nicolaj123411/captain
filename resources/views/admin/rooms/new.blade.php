                ...
                <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                                <div class="card card-border-color card-border-color-primary">
                                        <div class="card-header card-header-divider">Create new room for <strong>{{$house->title}}</strong><span class="card-subtitle">Edit the fields and make sure to save.</span></div>
                                        <div class="card-body">
                                            ...
                                            @endif
                                                @if ($errors->any())
                                                    ...
                                                    @endforeach
                                            @endif
                                        <form method="POST" action="{{ route('room.create', $house->id) }}">
                                                {{ csrf_field() }}
                                            <div class="form-group pt-2">
                                              <label for="inputEmail">Room title</label>
                                              <input name="title" id="inputEmail" type="text" placeholder="Enter room title" class="form-control">
                                            </div>
