                                        ...
                                        <div class="card-body">
                                            ...
                                            @endif
                                                @if ($errors->any())
                                                    ...
                                                    @endforeach
                                            @endif
                                                    <form method="POST" action="{{route('room.alias.update', $room->id)}}">
                                                {{ csrf_field() }}
                                            <div class="form-group pt-2">
                                              <label for="title">Room title</label>
                                            <input name="title" value="{{$room->title}}" id="title" type="text" placeholder="Enter room title" class="form-control">
                                            </div>
